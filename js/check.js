...
function print_contact(){
    ...
    reader.onloadend = function(e){
        ...
        if(checkContact.valid){
            $("#contact-header").removeClass("invalid neutral").addClass(
                "valid");
        } else{
            $("#contact-header").removeClass("valid neutral").addClass(
                "invalid");
        }
    }
    reader.readAsText(file);
...
function print_phone(){
    ...
    reader.onloadend = function(e){
        ...
        checkPhone.errors;
        if(checkPhone.valid){
            $("#phone-header").removeClass("invalid neutral").addClass(
                "valid");
        } else{
            $("#phone-header").removeClass("valid neutral").addClass(
                "invalid");
        }
    }
    reader.readAsText(file);
...
function print_internet(){
    ...
    reader.onloadend = function(e){
        ...
        if(checkInternet.valid){
            $("#internet-header").removeClass("invalid neutral").addClass(
                "valid");
        } else{
            $("#internet-header").removeClass("valid neutral").addClass(
                "invalid");
        }
    }
    reader.readAsText(file);
...
function print_funding(){
    ...
    reader.onloadend = function(e){
        ...
        if(checkFunding.valid){
            $("#funding-header").removeClass("invalid neutral").addClass(
                "valid");
        } else{
            $("#funding-header").removeClass("valid neutral").addClass(
                "invalid");
        }
    }
    reader.readAsText(file);
